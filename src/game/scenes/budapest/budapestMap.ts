...
export const BUDAPEST_CHECKPOINT_ZONES: CheckpointZone[] = [
  {
    id: 'bp_eye',
    centerX: tileToWorld(27, 23).x,
    centerY: tileToWorld(27, 23).y,
    radius: 56,
    promptText: 'Ride the Budapest Eye?',
  },
  {
    id: 'bp_airbnb',
    centerX: tileToWorld(36, 31).x,
    centerY: tileToWorld(36, 31).y,
    radius: 48,
    promptText: 'Enter Airbnb',
  },
  {
    id: 'bp_jewish_quarter',
    centerX: tileToWorld(42, 27).x,
    centerY: tileToWorld(42, 27).y,
    radius: 56,
  ...
  {
    id: 'bp_restaurant_1',
    centerX: tileToWorld(10, 31).x,
    centerY: tileToWorld(10, 31).y,
    radius: 48,
    promptText: 'Enter Restaurant',
  },
  {
    id: 'bp_restaurant_2',
    centerX: tileToWorld(18, 31).x,
    centerY: tileToWorld(18, 31).y,
    radius: 48,
    promptText: 'Enter Restaurant',
  },
  {
    id: 'bp_parliament',
    centerX: tileToWorld(14, 16).x,
    centerY: tileToWorld(14, 16).y,
    radius: 56,
