...
export const BUDAPEST_CHECKPOINT_ZONES: CheckpointZone[] = [
  ...
  {
    id: 'bp_gellert_hill',
    centerX: tileToWorld(4, 5).x,
    centerY: tileToWorld(4, 5).y,
    radius: 56,
  ...
  {
    id: 'bp_jazz_seat',
    centerX: tileToWorld(56, 28).x,
    centerY: tileToWorld(56, 28).y,
    radius: 48,
    promptText: 'Jazz Club',
  },
  {
    id: 'bp_rooftop_chase',
    centerX: tileToWorld(5, 16).x,
    centerY: tileToWorld(5, 16).y,
    radius: 48,
    promptText: 'Rooftop View',
  },
  {
    id: 'bp_danube_kayak',
    centerX: tileToWorld(28, 16).x,
    centerY: tileToWorld(28, 16).y,
    radius: 48,
