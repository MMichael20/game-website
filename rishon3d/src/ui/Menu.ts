...
function injectMenuStyle(): void {
  ...
  s.textContent = [
    ...
    "padding:24px 32px;animation:r3dFade .5s ease both;}",
    ".r3d-title{font-size:40px;margin:0;letter-spacing:2px;",
    ...
    ".r3d-tag{margin:0;opacity:0.82;font-size:15px;}",
    ...
    ".r3d-btn{padding:10px 34px;font-size:16px;border:0;border-radius:10px;cursor:pointer;",
...
export class Menu {
  ...
  showPause(): void {
    this.root.innerHTML = [
      '<div class="r3d-card">',
      '<h2 class="r3d-title" style="font-size:28px">Paused</h2>',
